...
import com.liyi.xlib.util.blur.FastBlur;
import com.liyi.xlib.util.blur.RSBlur;
...
public final class ImageUtil {
     ...
     * @return bitmap
     */
    public static Bitmap drawable2Bitmap(@NonNull Context context, @DrawableRes int resId) {
     ...
     * @return bitmap
     */
    public static Bitmap getBitmap(@NonNull Context context, @DrawableRes int resId, int maxWidth, int maxHeight) {
     ...
     * @return drawable
     */
    public static Drawable bytes2Drawable(@NonNull Context context, byte[] bytes) {
    ...
    public static Bitmap stackBlurByRS(@NonNull Context context, Bitmap src, @IntRange(from = 0, to = 25) int radius) {
        if (src == null) return null;
