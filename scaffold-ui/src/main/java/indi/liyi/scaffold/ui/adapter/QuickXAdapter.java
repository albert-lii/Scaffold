package indi.liyi.scaffold.ui.adapter;
...
public abstract class QuickXAdapter<T, VH extends BaseXHolder> extends BaseXAdapter<VH> {
    ...
    protected VH createBaseViewHolder(View view) {
        ...
        // 泛型擦除会导致 z 为 null
        if (z == null) {
            k = (VH) new BaseXHolder(view);
        } else {
            k = createGenericKInstance(z, view);
        }
        return k != null ? k : (VH) new BaseXHolder(view);
    }
        ...
        if (type instanceof ParameterizedType) {
            ...
            for (Type temp : types) {
                if (temp instanceof Class) {
                    ...
                    if (BaseXHolder.class.isAssignableFrom(tempClass)) {
                        return tempClass;
                    }
                } else if (temp instanceof ParameterizedType) {
                    Type rawType = ((ParameterizedType) temp).getRawType();
                    if (rawType instanceof Class && BaseXHolder.class.isAssignableFrom((Class<?>) rawType)) {
