...
public class BaseXDialogFragment extends DialogFragment {
    ...
    // 是否使用 dialog 的百分比尺寸
    private final boolean DEF_SIZE_PERCENT_ENABLED = false;
    // 是否设置 dialog 的尺寸
    private final boolean DEF_SET_SIZE_ENABLED = false;
    // 默认的 dialog 的宽占屏宽的比
    ...
    private boolean isUseSizePercent = DEF_SIZE_PERCENT_ENABLED;
    // 是否设置 dialog 的尺寸
    private boolean isSetSize = DEF_SET_SIZE_ENABLED;
    // dialog 的宽所占屏幕的百分比
     ...
     */
    public void setSizePercentEnabled(boolean enable) {
