...
import indi.liyi.scaffold.http.interceptor.BaseUrlInterceptor;
import indi.liyi.scaffold.http.interceptor.DownloadInterceptor;
import indi.liyi.scaffold.http.interceptor.LoggingInterceptor;
import indi.liyi.scaffold.http.interceptor.OfflineCacheControlInterceptor;
...
//                .addConverterFactory(ScalarsConverterFactory.create())
    ...
    private OkHttpClient createOkHttpClient() {
        ...
        OkHttpClient.Builder builder = new OkHttpClient.Builder()
                ...
                .cache(cache);
        // 当有多个域名需求时添加
        if (mHostMap != null && !mHostMap.isEmpty() && !TextUtils.isEmpty(mUrlKey)) {
